 ...
 */
    ...
    public function getLesMoisAnneeDisponibles(){
    ...
    public function getnb($idVisiteur,$mois){
        $req = "SELECT count(*) from fichefrais
			where fichefrais.idVisiteur ='$idVisiteur' and fichefrais.mois = '$mois'";
    ...
    public function getLesInfosSuiviFrais($mois){
        /*$req = "SELECT (quantite*montant) AS totqte, idFraisForfait 
        from lignefraisforfait 
        INNER JOIN fraisforfait ON lignefraisforfait.idFraisForfait = fraisforfait.id 
        where mois='$mois' group by idFraisForfait";*/
        $req ="select SUM(quantite) AS totqte, idFraisForfait from lignefraisforfait where mois='$mois' group by idFraisForfait";
